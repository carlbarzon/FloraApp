...
import AgaveSwiper from "../assets/agaveSwiper";

const AgaveDetailScreen = ({ navigation }) => {
  return (
    <View
      style={{
        flex: 1,
    ...
    >
      ...
      >
        ...
        >
          <TouchableOpacity
            onPress={() => navigation.navigate("AgaveDescription")}
          >
            <Text
              style={{
                color: "#62636a",
...
export default AgaveDetailScreen;
