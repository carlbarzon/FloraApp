...
import BegoniaSwiper from "../assets/begoniaSwiper";

const BegoniaDetailScreen = ({ navigation }) => {
  return (
    <View
      style={{
        flex: 1,
    ...
    >
      ...
      >
        ...
        >
          <TouchableOpacity
            onPress={() => navigation.navigate("BegoniaDescription")}
          >
            <Text
              style={{
                color: "#62636a",
...
export default BegoniaDetailScreen;
