...
import AppleSwiper from "../assets/appleSwiper";

const AppleDetailScreen = ({ navigation }) => {
  return (
    <View
      style={{
        flex: 1,
    ...
    >
      ...
      >
        ...
        >
          <TouchableOpacity
            onPress={() => navigation.navigate("AppleDescription")}
          >
            <Text
              style={{
                color: "#62636a",
...
export default AppleDetailScreen;
